...
export interface IAlgebraPoolLegacy extends BaseContract {
    ...
    getFunction(nameOrSignature: "getCommunityFeePending"): TypedContractMethod<[
    ], [
        [
            bigint,
            bigint
    ...
    getFunction(nameOrSignature: "getPluginFeePending"): TypedContractMethod<[
    ], [
        [
            bigint,
            bigint
    ...
    getFunction(nameOrSignature: "tickTable"): TypedContractMethod<[wordPosition: BigNumberish], [bigint], "view">;
