...
export interface MockTimeAlgebraPoolInterface extends Interface {
    getFunction(nameOrSignature: "advanceTime" | "burn" | "checkBlockTimestamp" | "collect" | "communityVault" | "factory" | "fee" | "flash" | "getCommunityFeePending" | "getKeyForLimitPosition" | "getKeyForPosition" | "getPluginFeePending" | "getReserves" | "globalState" | "initialize" | "isUnlocked" | "lastFeeTransferTimestamp" | "liquidity" | "maxLiquidityPerTick" | "mint" | "nextTickGlobal" | "plugin" | "positions" | "prevTickGlobal" | "safelyGetStateOfAMM" | "setCommunityFee" | "setCommunityVault" | "setFee" | "setPlugin" | "setPluginConfig" | "setTickSpacing" | "setTotalFeeGrowth0Token" | "setTotalFeeGrowth1Token" | "skim" | "swap" | "swapWithPaymentInAdvance" | "sync" | "tickSpacing" | "tickTable" | "tickTreeRoot" | "tickTreeSecondLayer" | "ticks" | "time" | "token0" | "token1" | "totalFeeGrowth0Token" | "totalFeeGrowth1Token"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "checkBlockTimestamp", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "getKeyForLimitPosition", values: [AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "getKeyForPosition", values: [AddressLike, BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "setTotalFeeGrowth0Token", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "setTotalFeeGrowth1Token", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "checkBlockTimestamp", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getKeyForLimitPosition", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getKeyForPosition", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setTotalFeeGrowth0Token", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setTotalFeeGrowth1Token", data: BytesLike): Result;
...
export interface MockTimeAlgebraPool extends BaseContract {
    ...
    getFunction(nameOrSignature: "advanceTime"): TypedContractMethod<[by: BigNumberish], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "checkBlockTimestamp"): TypedContractMethod<[], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "getKeyForLimitPosition"): TypedContractMethod<[
        owner: AddressLike,
        tick: BigNumberish
    ], [
        string
    ], "view">;
    getFunction(nameOrSignature: "getKeyForPosition"): TypedContractMethod<[
        owner: AddressLike,
        bottomTick: BigNumberish,
        topTick: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "setTotalFeeGrowth0Token"): TypedContractMethod<[
        _totalFeeGrowth0Token: BigNumberish
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "setTotalFeeGrowth1Token"): TypedContractMethod<[
        _totalFeeGrowth1Token: BigNumberish
    ], [
        void
    ], "nonpayable">;
