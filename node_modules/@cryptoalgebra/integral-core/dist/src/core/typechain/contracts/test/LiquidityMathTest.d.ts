...
export interface LiquidityMathTestInterface extends Interface {
    getFunction(nameOrSignature: "addDelta" | "getGasCostOfAddDelta"): FunctionFragment;
...
export interface LiquidityMathTest extends BaseContract {
    ...
    getFunction(nameOrSignature: "addDelta"): TypedContractMethod<[x: BigNumberish, y: BigNumberish], [bigint], "view">;
    getFunction(nameOrSignature: "getGasCostOfAddDelta"): TypedContractMethod<[x: BigNumberish, y: BigNumberish], [bigint], "view">;
    filters: {};
}
