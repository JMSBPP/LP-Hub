...
export interface TickMathEchidnaTestInterface extends Interface {
    getFunction(nameOrSignature: "checkGetSqrtRatioAtTickInvariants" | "checkGetTickAtSqrtRatioInvariants"): FunctionFragment;
...
export interface TickMathEchidnaTest extends BaseContract {
    ...
    getFunction(nameOrSignature: "checkGetSqrtRatioAtTickInvariants"): TypedContractMethod<[tick: BigNumberish], [void], "view">;
    getFunction(nameOrSignature: "checkGetTickAtSqrtRatioInvariants"): TypedContractMethod<[ratio: BigNumberish], [void], "view">;
    filters: {};
}
