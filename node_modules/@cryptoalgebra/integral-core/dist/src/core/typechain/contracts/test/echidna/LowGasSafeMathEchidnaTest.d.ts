...
export interface LowGasSafeMathEchidnaTestInterface extends Interface {
    getFunction(nameOrSignature: "checkAdd" | "checkAddi" | "checkMul" | "checkSub" | "checkSubi"): FunctionFragment;
...
export interface LowGasSafeMathEchidnaTest extends BaseContract {
    ...
    getFunction(nameOrSignature: "checkAdd"): TypedContractMethod<[x: BigNumberish, y: BigNumberish], [void], "view">;
    getFunction(nameOrSignature: "checkAddi"): TypedContractMethod<[x: BigNumberish, y: BigNumberish], [void], "view">;
    getFunction(nameOrSignature: "checkMul"): TypedContractMethod<[x: BigNumberish, y: BigNumberish], [void], "view">;
    getFunction(nameOrSignature: "checkSub"): TypedContractMethod<[x: BigNumberish, y: BigNumberish], [void], "view">;
    getFunction(nameOrSignature: "checkSubi"): TypedContractMethod<[x: BigNumberish, y: BigNumberish], [void], "view">;
    filters: {};
}
