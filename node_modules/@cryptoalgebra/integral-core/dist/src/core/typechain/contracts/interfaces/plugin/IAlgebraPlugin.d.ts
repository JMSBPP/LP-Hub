...
export interface IAlgebraPluginInterface extends Interface {
    getFunction(nameOrSignature: "afterFlash" | "afterInitialize" | "afterModifyPosition" | "afterSwap" | "beforeFlash" | "beforeInitialize" | "beforeModifyPosition" | "beforeSwap" | "defaultPluginConfig" | "handlePluginFee"): FunctionFragment;
...
export interface IAlgebraPlugin extends BaseContract {
    ...
    handlePluginFee: TypedContractMethod<[
        pluginFee0: BigNumberish,
        pluginFee1: BigNumberish
    ], [
        string
    ], "nonpayable">;
