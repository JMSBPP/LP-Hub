...
export interface PropBalancesEchidnaTestInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "echidna_check_balances_not_zero", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "echidna_check_balances_not_zero", data: BytesLike): Result;
...
export interface PropBalancesEchidnaTest extends BaseContract {
    ...
    getFunction(nameOrSignature: "echidna_check_balances_not_zero"): TypedContractMethod<[], [boolean], "view">;
