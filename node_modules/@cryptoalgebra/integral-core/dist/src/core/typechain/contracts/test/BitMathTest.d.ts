...
export interface BitMathTestInterface extends Interface {
    getFunction(nameOrSignature: "getGasCostOfLeastSignificantBit" | "leastSignificantBit"): FunctionFragment;
...
export interface BitMathTest extends BaseContract {
    ...
    getFunction(nameOrSignature: "getGasCostOfLeastSignificantBit"): TypedContractMethod<[x: BigNumberish], [bigint], "view">;
    getFunction(nameOrSignature: "leastSignificantBit"): TypedContractMethod<[x: BigNumberish], [bigint], "view">;
    filters: {};
}
