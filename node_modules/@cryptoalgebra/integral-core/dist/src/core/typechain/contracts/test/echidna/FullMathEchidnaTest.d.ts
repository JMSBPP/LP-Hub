...
export interface FullMathEchidnaTestInterface extends Interface {
    getFunction(nameOrSignature: "checkMulDiv" | "checkMulDivRounding" | "checkMulDivRoundingUp"): FunctionFragment;
...
export interface FullMathEchidnaTest extends BaseContract {
    ...
    getFunction(nameOrSignature: "checkMulDiv"): TypedContractMethod<[
        x: BigNumberish,
        y: BigNumberish,
        d: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "checkMulDivRounding"): TypedContractMethod<[
        x: BigNumberish,
        y: BigNumberish,
        d: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "checkMulDivRoundingUp"): TypedContractMethod<[
        x: BigNumberish,
        y: BigNumberish,
        d: BigNumberish
    ], [
