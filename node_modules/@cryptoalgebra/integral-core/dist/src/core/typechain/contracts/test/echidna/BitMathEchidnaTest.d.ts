...
export interface BitMathEchidnaTestInterface extends Interface {
    getFunction(nameOrSignature: "leastSignificantBitInvariant"): FunctionFragment;
...
export interface BitMathEchidnaTest extends BaseContract {
    ...
    getFunction(nameOrSignature: "leastSignificantBitInvariant"): TypedContractMethod<[input: BigNumberish], [void], "view">;
    filters: {};
}
