...
import type { SwapCalculation, SwapCalculationInterface } from "../../../contracts/base/SwapCalculation";
export declare class SwapCalculation__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): SwapCalculation;
}
