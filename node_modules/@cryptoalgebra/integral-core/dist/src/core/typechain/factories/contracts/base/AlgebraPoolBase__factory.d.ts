...
import type { AlgebraPoolBase, AlgebraPoolBaseInterface } from "../../../contracts/base/AlgebraPoolBase";
export declare class AlgebraPoolBase__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): AlgebraPoolBase;
}
