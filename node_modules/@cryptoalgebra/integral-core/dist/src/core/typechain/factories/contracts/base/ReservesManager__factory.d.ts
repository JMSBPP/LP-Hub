...
import type { ReservesManager, ReservesManagerInterface } from "../../../contracts/base/ReservesManager";
export declare class ReservesManager__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): ReservesManager;
}
