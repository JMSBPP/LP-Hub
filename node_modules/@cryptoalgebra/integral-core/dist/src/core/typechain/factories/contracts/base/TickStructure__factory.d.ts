...
import type { TickStructure, TickStructureInterface } from "../../../contracts/base/TickStructure";
export declare class TickStructure__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): TickStructure;
}
