...
export interface TestAlgebraReentrantCalleeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "algebraSwapCallback"
...
export interface TestAlgebraReentrantCallee extends BaseContract {
  connect(runner?: ContractRunner | null): TestAlgebraReentrantCallee;
  waitForDeployment(): Promise<this>;

  interface: TestAlgebraReentrantCalleeInterface;
