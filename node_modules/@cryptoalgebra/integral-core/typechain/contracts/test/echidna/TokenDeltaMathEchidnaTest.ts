...
export interface TokenDeltaMathEchidnaTestInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TokenDeltaMathEchidnaTest extends BaseContract {
  connect(runner?: ContractRunner | null): TokenDeltaMathEchidnaTest;
  ...
  getToken0DeltaEquivalency: TypedContractMethod<
    [
      sqrtP: BigNumberish,
      sqrtQ: BigNumberish,
      liquidity: BigNumberish,
  ...
  getToken0DeltaInvariants: TypedContractMethod<
    [sqrtP: BigNumberish, sqrtQ: BigNumberish, liquidity: BigNumberish],
    [void],
    "view"
  >;

  getToken0DeltaSignedInvariants: TypedContractMethod<
    [sqrtP: BigNumberish, sqrtQ: BigNumberish, liquidity: BigNumberish],
    [void],
    "view"
  >;

  getToken1DeltaInvariants: TypedContractMethod<
    [sqrtP: BigNumberish, sqrtQ: BigNumberish, liquidity: BigNumberish],
    [void],
    "view"
  >;

  getToken1DeltaSignedInvariants: TypedContractMethod<
    [sqrtP: BigNumberish, sqrtQ: BigNumberish, liquidity: BigNumberish],
    [void],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getToken0DeltaEquivalency"
  ): TypedContractMethod<
    [
      sqrtP: BigNumberish,
      sqrtQ: BigNumberish,
  ...
  >;
  getFunction(
    nameOrSignature: "getToken0DeltaInvariants"
  ): TypedContractMethod<
    [sqrtP: BigNumberish, sqrtQ: BigNumberish, liquidity: BigNumberish],
    [void],
    "view"
  >;
  getFunction(
    nameOrSignature: "getToken0DeltaSignedInvariants"
  ): TypedContractMethod<
    [sqrtP: BigNumberish, sqrtQ: BigNumberish, liquidity: BigNumberish],
    [void],
    "view"
  >;
  getFunction(
    nameOrSignature: "getToken1DeltaInvariants"
  ): TypedContractMethod<
    [sqrtP: BigNumberish, sqrtQ: BigNumberish, liquidity: BigNumberish],
    [void],
    "view"
  >;
  getFunction(
    nameOrSignature: "getToken1DeltaSignedInvariants"
  ): TypedContractMethod<
    [sqrtP: BigNumberish, sqrtQ: BigNumberish, liquidity: BigNumberish],
    [void],
    "view"
