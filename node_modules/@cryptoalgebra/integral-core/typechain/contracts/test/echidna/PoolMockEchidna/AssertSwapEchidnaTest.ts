...
export interface AssertSwapEchidnaTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
...
export interface AssertSwapEchidnaTest extends BaseContract {
  connect(runner?: ContractRunner | null): AssertSwapEchidnaTest;
  waitForDeployment(): Promise<this>;

  interface: AssertSwapEchidnaTestInterface;
