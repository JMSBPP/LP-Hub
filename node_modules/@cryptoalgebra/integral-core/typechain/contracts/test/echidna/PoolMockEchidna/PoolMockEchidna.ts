...
export interface PoolMockEchidnaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
...
export interface PoolMockEchidna extends BaseContract {
  connect(runner?: ContractRunner | null): PoolMockEchidna;
  waitForDeployment(): Promise<this>;

  interface: PoolMockEchidnaInterface;
