...
export interface PropBalancesEchidnaTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      ...
      | "communityVault"
      | "donate"
      | "echidna_check_balances_not_zero"
      | "factory"
      | "fee"
      | "flash"
      | "flashWrapped"
  ...
  encodeFunctionData(
    functionFragment: "echidna_check_balances_not_zero",
    values?: undefined
  ): string;
...
export interface PropBalancesEchidnaTest extends BaseContract {
  connect(runner?: ContractRunner | null): PropBalancesEchidnaTest;
  waitForDeployment(): Promise<this>;

  interface: PropBalancesEchidnaTestInterface;
  ...
  echidna_check_balances_not_zero: TypedContractMethod<[], [boolean], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "echidna_check_balances_not_zero"
