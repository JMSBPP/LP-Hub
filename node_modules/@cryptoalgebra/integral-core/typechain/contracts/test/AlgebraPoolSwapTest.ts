...
export interface AlgebraPoolSwapTestInterface extends Interface {
  getFunction(
    nameOrSignature: "algebraSwapCallback" | "getSwapResult"
  ): FunctionFragment;
...
export interface AlgebraPoolSwapTest extends BaseContract {
  connect(runner?: ContractRunner | null): AlgebraPoolSwapTest;
  waitForDeployment(): Promise<this>;

  interface: AlgebraPoolSwapTestInterface;
