...
export interface ReservesManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "collect"
...
export interface ReservesManager extends BaseContract {
  connect(runner?: ContractRunner | null): ReservesManager;
  waitForDeployment(): Promise<this>;

  interface: ReservesManagerInterface;
