...
export interface AlgebraPoolBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "collect"
...
export interface AlgebraPoolBase extends BaseContract {
  connect(runner?: ContractRunner | null): AlgebraPoolBase;
  waitForDeployment(): Promise<this>;

  interface: AlgebraPoolBaseInterface;
