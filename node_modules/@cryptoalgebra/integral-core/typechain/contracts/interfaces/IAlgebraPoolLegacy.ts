...
export interface IAlgebraPoolLegacyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "collect"
...
export interface IAlgebraPoolLegacy extends BaseContract {
  connect(runner?: ContractRunner | null): IAlgebraPoolLegacy;
  waitForDeployment(): Promise<this>;

  interface: IAlgebraPoolLegacyInterface;
