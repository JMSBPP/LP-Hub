...
import type {
  AlgebraPoolSwapTest,
  AlgebraPoolSwapTestInterface,
} from "../../../contracts/test/AlgebraPoolSwapTest";
...
type AlgebraPoolSwapTestConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: AlgebraPoolSwapTestConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class AlgebraPoolSwapTest__factory extends ContractFactory {
  constructor(...args: AlgebraPoolSwapTestConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): AlgebraPoolSwapTest__factory {
    return super.connect(runner) as AlgebraPoolSwapTest__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): AlgebraPoolSwapTestInterface {
    return new Interface(_abi) as AlgebraPoolSwapTestInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AlgebraPoolSwapTest;
  }
}
