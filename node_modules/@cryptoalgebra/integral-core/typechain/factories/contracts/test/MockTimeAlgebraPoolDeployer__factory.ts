...
import type {
  ...
  MockTimeAlgebraPoolDeployerInterface,
} from "../../../contracts/test/MockTimeAlgebraPoolDeployer";
...
type MockTimeAlgebraPoolDeployerConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: MockTimeAlgebraPoolDeployerConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class MockTimeAlgebraPoolDeployer__factory extends ContractFactory {
  ...
  ): MockTimeAlgebraPoolDeployer__factory {
    return super.connect(runner) as MockTimeAlgebraPoolDeployer__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): MockTimeAlgebraPoolDeployerInterface {
    return new Interface(_abi) as MockTimeAlgebraPoolDeployerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as MockTimeAlgebraPoolDeployer;
  }
}
