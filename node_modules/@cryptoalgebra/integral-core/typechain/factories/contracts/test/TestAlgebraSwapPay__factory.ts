...
import type {
  TestAlgebraSwapPay,
  TestAlgebraSwapPayInterface,
} from "../../../contracts/test/TestAlgebraSwapPay";
...
type TestAlgebraSwapPayConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TestAlgebraSwapPayConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class TestAlgebraSwapPay__factory extends ContractFactory {
  constructor(...args: TestAlgebraSwapPayConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): TestAlgebraSwapPay__factory {
    return super.connect(runner) as TestAlgebraSwapPay__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TestAlgebraSwapPayInterface {
    return new Interface(_abi) as TestAlgebraSwapPayInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TestAlgebraSwapPay {
    return new Contract(address, _abi, runner) as unknown as TestAlgebraSwapPay;
  }
}
