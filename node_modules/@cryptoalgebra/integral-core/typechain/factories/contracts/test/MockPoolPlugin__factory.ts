...
import type {
  MockPoolPlugin,
  MockPoolPluginInterface,
} from "../../../contracts/test/MockPoolPlugin";
...
type MockPoolPluginConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: MockPoolPluginConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class MockPoolPlugin__factory extends ContractFactory {
  constructor(...args: MockPoolPluginConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): MockPoolPlugin__factory {
    return super.connect(runner) as MockPoolPlugin__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): MockPoolPluginInterface {
    return new Interface(_abi) as MockPoolPluginInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): MockPoolPlugin {
    return new Contract(address, _abi, runner) as unknown as MockPoolPlugin;
  }
}
