...
import type {
  TokenDeltaMathTest,
  TokenDeltaMathTestInterface,
} from "../../../contracts/test/TokenDeltaMathTest";
...
type TokenDeltaMathTestConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TokenDeltaMathTestConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class TokenDeltaMathTest__factory extends ContractFactory {
  constructor(...args: TokenDeltaMathTestConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): TokenDeltaMathTest__factory {
    return super.connect(runner) as TokenDeltaMathTest__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TokenDeltaMathTestInterface {
    return new Interface(_abi) as TokenDeltaMathTestInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TokenDeltaMathTest {
    return new Contract(address, _abi, runner) as unknown as TokenDeltaMathTest;
  }
}
