...
import type {
  TickTreeTest,
  TickTreeTestInterface,
} from "../../../contracts/test/TickTreeTest";
...
type TickTreeTestConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TickTreeTestConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class TickTreeTest__factory extends ContractFactory {
  constructor(...args: TickTreeTestConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): TickTreeTest__factory {
    return super.connect(runner) as TickTreeTest__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TickTreeTestInterface {
    return new Interface(_abi) as TickTreeTestInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TickTreeTest {
    return new Contract(address, _abi, runner) as unknown as TickTreeTest;
  }
}
