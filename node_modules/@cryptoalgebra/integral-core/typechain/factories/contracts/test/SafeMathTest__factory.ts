...
import type {
  SafeMathTest,
  SafeMathTestInterface,
} from "../../../contracts/test/SafeMathTest";
...
type SafeMathTestConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: SafeMathTestConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class SafeMathTest__factory extends ContractFactory {
  constructor(...args: SafeMathTestConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): SafeMathTest__factory {
    return super.connect(runner) as SafeMathTest__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): SafeMathTestInterface {
    return new Interface(_abi) as SafeMathTestInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SafeMathTest {
    return new Contract(address, _abi, runner) as unknown as SafeMathTest;
  }
}
