...
export class Positions__factory {
  ...
  static createInterface(): PositionsInterface {
    return new Interface(_abi) as PositionsInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Positions {
    return new Contract(address, _abi, runner) as unknown as Positions;
  }
}
