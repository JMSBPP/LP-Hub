...
import type {
  SwapCalculation,
  SwapCalculationInterface,
} from "../../../contracts/base/SwapCalculation";
...
export class SwapCalculation__factory {
  static readonly abi = _abi;
  static createInterface(): SwapCalculationInterface {
    return new Interface(_abi) as SwapCalculationInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SwapCalculation {
    return new Contract(address, _abi, runner) as unknown as SwapCalculation;
  }
}
