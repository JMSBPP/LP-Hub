...
import type {
  ReservesManager,
  ReservesManagerInterface,
} from "../../../contracts/base/ReservesManager";
...
export class ReservesManager__factory {
  static readonly abi = _abi;
  static createInterface(): ReservesManagerInterface {
    return new Interface(_abi) as ReservesManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ReservesManager {
    return new Contract(address, _abi, runner) as unknown as ReservesManager;
  }
}
