...
import type {
  TickStructure,
  TickStructureInterface,
} from "../../../contracts/base/TickStructure";
...
export class TickStructure__factory {
  static readonly abi = _abi;
  static createInterface(): TickStructureInterface {
    return new Interface(_abi) as TickStructureInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TickStructure {
    return new Contract(address, _abi, runner) as unknown as TickStructure;
  }
}
