...
import type {
  AlgebraPoolBase,
  AlgebraPoolBaseInterface,
} from "../../../contracts/base/AlgebraPoolBase";
...
export class AlgebraPoolBase__factory {
  static readonly abi = _abi;
  static createInterface(): AlgebraPoolBaseInterface {
    return new Interface(_abi) as AlgebraPoolBaseInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): AlgebraPoolBase {
    return new Contract(address, _abi, runner) as unknown as AlgebraPoolBase;
  }
}
