...
import type {
  IAlgebraPoolLegacy,
  IAlgebraPoolLegacyInterface,
} from "../../../contracts/interfaces/IAlgebraPoolLegacy";
...
export class IAlgebraPoolLegacy__factory {
  static readonly abi = _abi;
  static createInterface(): IAlgebraPoolLegacyInterface {
    return new Interface(_abi) as IAlgebraPoolLegacyInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IAlgebraPoolLegacy {
    return new Contract(address, _abi, runner) as unknown as IAlgebraPoolLegacy;
  }
}
